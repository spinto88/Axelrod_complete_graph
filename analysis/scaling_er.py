...
data = pd.read_csv('Data_processed/Critical_values_ER.csv')
...
fp = open('Exponents_data/Exponents_ER.dat','w')
...
plt.legend(loc = 'best')
plt.savefig('images/pcN_ER.png', dpi = 300)
plt.show()
...
plt.yticks(size = 15)
plt.grid(True, alpha = 0.15)
plt.savefig('images/pcN2_ER.png', dpi = 300)
...
plt.savefig('images/ScN_ER.png', dpi = 300)
