...
for N in [512, 768, 1024, 2048, 4096]:
  ...
  try:
    ...
    data_bigfrag = biggest_fragment('Data_ER/Data_RN_N{}.dat'.format(N))
    data_fragments = average_fragment('Data_ER/Data_RN_N{}.dat'.format(N))
   
    p = [b[0]/(N-1) for b in data_fragments]
